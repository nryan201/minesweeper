...
gui::Button::Button(float x, float y, float width, float height,
                    ...
                    sf::Color oultine_idle_color, sf::Color oultine_hover_color, sf::Color oultine_active_color,
                    short unsigned id)
{
    ...
    this->shape.setOutlineColor(oultine_idle_color);
    ...
    this->text.setPosition(
            this->shape.getPosition().x + (width - this->text.getGlobalBounds().width) / 2.f,
            this->shape.getPosition().y + (height - this->text.getGlobalBounds().height) / 2.f
    );
    ...
    this->oultineidleColor = oultine_idle_color;
    this->oultinehoverColor = oultine_hover_color;
    this->oultineactiveColor = oultine_active_color;
...
void gui::Button::update(const sf::Vector2f& mousePos)
{
    ...
    switch (this->buttonState) {
        ...
        case BTN_IDLE:
            ...
            this->shape.setOutlineColor(this->oultineidleColor);
        ...
        case BTN_ACTIVE :
            ...
            this->shape.setOutlineColor(this->oultineactiveColor);
        ...
        case BTN_HOVER:
            ...
            this->shape.setOutlineColor(this->oultinehoverColor);
            break;
...
:font(font),showList(false),keytimeMax(1.f),keytime(0.f) {
    this->activeElement = new gui::Button
            (x, y, width, height, &this->font, list[default_index], 16,
             ...
             sf::Color(70, 70, 70, 200), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 200),
