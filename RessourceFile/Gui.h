...
class Button {
    ...
    sf::Color oultineidleColor;
    sf::Color oultinehoverColor;
    sf::Color oultineactiveColor;
    public:
    Button(float x, float y, float width, float height,
            sf::Font *font, std::string text, unsigned character_size,
            sf::Color text_idle_color, sf::Color text_hover_color, sf::Color text_active_color,
            sf::Color idle_color, sf::Color hover_color, sf::Color active_color,
           sf::Color oultine_idle_color = sf::Color::Transparent, sf::Color oultine_hover_color= sf::Color::Transparent, sf::Color oultine_active_color= sf::Color::Transparent,
            short unsigned id =0);
        virtual ~Button();
